...
# Crea un objeto Thread y proporciona la función que se ejecutará en ese hilo
hilo = threading.Thread(target=mi_funcion)

# Inicia la ejecución del hilo
hilo.start()

# El hilo principal sigue ejecutando su código mientras que el hilo secundario se ejecuta en paralelo
for i in range(5):
